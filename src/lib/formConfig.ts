...
export const FIELD_IDS = {
  serviceNeeded: "UNqmf9fKO4rG50RKRYLv",
    leadSource: "lV5r3w9qyETZhseZHRyK",
    utmSource: "k9bDNhrqFo9kZGijTZIC",
    utmMedium: "ptpTKxIDZiv84N3ZxQJR",
    utmCampaign: "U5r6Jn0fKsJD8u8VwCV6",

    propertyType: "doeIUE6lAUCs7LNBz2GX",
    ...
    callToDiscussSolar: "rzdEbRrjde6LMGOOYqJQ",
    solarInterests: "3toghHWyfHbN8caq1lbO",

    heatPumpPurpose: "zgGFzh2FwKNvjQQupCmY",
    roomsOrSpaceSize: "YDWB7sdBm2rMsdgFaynI",
    existingHeatPump: "MD37LgC5KgbCn6PzTBrH",
    whenLookingToInstall: "pQ7oJavKOiOb2OZFj2Sz",

    whatDoYouNeedDone: "0CSj9UwVhKYjktbtLJvy",
    urgent: "piTk9cc4rxzW5FixWUH2",
    whenLookingToGetThisDone: "v1NJp2zU8IAeB6NGFlAQ",

    projectType: "NICc1buMQRGrEeqopB82",
    projectStage: "kFUdEtcC2gM8J3uD2YvY",
    plansUpload: "kxOLi2RB1jTiuWiy35mN",
    projectScope: "tixB45OPkV0oIh8Gyz7n",
    builderName: "gUrJkUzHkt0dqRW3SS5K",

    commercialWorkType: "qzv5L4c1itUo99hIte4i",
    commercialSiteAddress: "QZHo5EoyI9lJVzuQ2BtR",
    commercialTiming: "27CDf8FU2x6uMPSJu8N1",

    whatIsTheProblem: "S3as9mMCeD9epfPM6EBO",
    isItNotWorkingRightNow: "n0ENQJXJTf4mSI5ua4qi",
    isThisUrgent: "XCU4y30CD1c5zYEhH0j7",
    preferredVisitTime: "VrMvXLopTsD9u5vh78bT",

    otherEnquiryDetails: "14oaxXOw4uP18BliiPAX",
    additionalMessage: "cJy3iJ5mPB7xj17fFZS7",
    howDidYouHearAboutUs: "zHKhmLi1AJ8kLr4BGeuj",
} as const;
